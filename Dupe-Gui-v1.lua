...
local currentPhrase = "Duping item to player..."
...
ui.Parent = ScreenGui
ui.Active = true
ui.BackgroundColor3 = Color3.new(0, 0, 0.5)
...
Kill.Name = "Kill"
Kill.Parent = ui
Kill.BackgroundColor3 = Color3.new(0.2, 0.4, 0.8)
                ...
                if Tool ~= nil then
                    ...
                    spawn(function()
                        ...
                        if Player.Character.Humanoid.Health <= 15 then
                            ...
                            notify("Success: Duped item to selected player!.")
                        end
                    end)
                else
                    notify("Success: Duped item to selected player!.")
