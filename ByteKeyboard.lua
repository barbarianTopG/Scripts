...
local KEY_OUTLINE_COLOR = darkenColor(basePurple, 0.8) -- darker than keys, lighter than background
...
minimizeStroke.Color = KEY_OUTLINE_COLOR -- match key outline color
