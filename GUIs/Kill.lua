...
G2L["Frame_2"]["Position"] = UDim2.new(0.34639, 0, 0.26597, 0)
...
G2L["Creator_4"]["Size"] = UDim2.new(0.56693, 0, 0.18462, 0)
G2L["Creator_4"]["Text"] = [[Made by StarFlow]]
G2L["Creator_4"]["Name"] = [[Creator]]
G2L["Creator_4"]["Position"] = UDim2.new(0.4252, 0, 0.01538, 0)
...
G2L["ScriptName_8"]["Size"] = UDim2.new(0.40157, 0, 0.18462, 0)
...
G2L["TextBox_d"] = Instance.new("TextBox", G2L["Frame_2"])
G2L["TextBox_d"]["CursorPosition"] = -1
G2L["TextBox_d"]["BorderSizePixel"] = 0
G2L["TextBox_d"]["TextWrapped"] = true
G2L["TextBox_d"]["TextColor3"] = Color3.fromRGB(113, 113, 113)
G2L["TextBox_d"]["TextScaled"] = true
G2L["TextBox_d"]["BackgroundColor3"] = Color3.fromRGB(31, 31, 31)
G2L["TextBox_d"]["PlaceholderText"] = [[DisplayName or Username]]
G2L["TextBox_d"]["Size"] = UDim2.new(0.74803, 0, 0.35385, 0)
G2L["TextBox_d"]["Position"] = UDim2.new(0.02362, 0, 0.23077, 0)
G2L["TextBox_d"]["Text"] = [[]]

G2L["UICorner_e"] = Instance.new("UICorner", G2L["TextBox_d"])

G2L["UIDragDetector_f"] = Instance.new("UIDragDetector", G2L["Frame_2"])
G2L["UIDragDetector_f"]["DragUDim2"] = UDim2.new(0, 23, 0, -1)

G2L["Loop_10"] = Instance.new("TextButton", G2L["Frame_2"])
G2L["Loop_10"]["TextWrapped"] = true
G2L["Loop_10"]["BorderSizePixel"] = 0
G2L["Loop_10"]["TextScaled"] = true
G2L["Loop_10"]["TextColor3"] = Color3.fromRGB(119, 0, 255)
G2L["Loop_10"]["BackgroundColor3"] = Color3.fromRGB(31, 31, 31)
G2L["Loop_10"]["Size"] = UDim2.new(0.4252, 0, 0.30769, 0)
G2L["Loop_10"]["Text"] = [[Looped: Off]]
G2L["Loop_10"]["Name"] = [[Loop]]
G2L["Loop_10"]["Position"] = UDim2.new(0.53543, 0, 0.63077, 0)

G2L["UICorner_11"] = Instance.new("UICorner", G2L["Loop_10"])

G2L["UIAspectRatioConstraint_12"] = Instance.new("UIAspectRatioConstraint", G2L["Frame_2"])
G2L["UIAspectRatioConstraint_12"]["AspectRatio"] = 1.95385
...
local function updatePlayerList()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        ...
        playerButton.MouseButton1Click:Connect(function()
            G2L["TextBox_d"].Text = player.Name
...
local function performKill()
    ...
    local Player = gplr(G2L["TextBox_d"].Text)[1]
    if not Player then
...
G2L["Loop_10"].MouseButton1Click:Connect(function()
    loopKillEnabled = not loopKillEnabled
    if loopKillEnabled then
        targetPlayer = gplr(G2L["TextBox_d"].Text)[1]
        if targetPlayer then
            G2L["Loop_10"].Text = "Looped: On"
            G2L["Loop_10"].BackgroundColor3 = Color3.fromRGB(80, 0, 160)
