...
local ProfileShadow = Instance.new("ImageLabel")
ProfileShadow.Size = UDim2.new(1, 10, 1, 10)
ProfileShadow.Position = UDim2.new(0, -5, 0, -5)
ProfileShadow.BackgroundTransparency = 1
ProfileShadow.Image = "rbxassetid://11542623335"
ProfileShadow.ScaleType = Enum.ScaleType.Slice
ProfileShadow.SliceCenter = Rect.new(23, 23, 277, 277)
ProfileShadow.Parent = ProfileContainer
...
local TimerGlow = Instance.new("ImageLabel")
TimerGlow.Size = UDim2.new(1, 20, 2, 20)
TimerGlow.Position = UDim2.new(0, -10, -0.5, -10)
TimerGlow.BackgroundTransparency = 1
TimerGlow.Image = "rbxassetid://11542568787"
TimerGlow.ImageColor3 = Color3.fromRGB(180, 100, 255)
TimerGlow.ScaleType = Enum.ScaleType.Slice
TimerGlow.SliceCenter = Rect.new(23, 23, 277, 277)
TimerGlow.Parent = TimerLine
