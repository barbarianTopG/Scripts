...
creditsBtn.MouseButton1Click:Connect(function()
    ...
    print("Page 1:")
    Wait(.1)
    print("Q - Rat Dance, E - Boogie, R - Unlock it, T - Hypnotic Data, Y - Sturdy V2, U - CaramellaDansen, P - Forget, F - Billy Bounce, G - Gangnam Style, H - Stadium Rave, J - Dancin, K, L, Z, X, C, V, N")
    Wait(.1)
    print("Page 2:")
    Wait(.1)
